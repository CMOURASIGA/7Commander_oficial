...
function roleDescription(role: string) { return ({ owner: "Controle principal da empresa.", admin: "Pode gerenciar usuários e configurações da empresa.", manager: "Atuação operacional, sem gestão de usuários.", member: "Acesso operacional básico aos módulos liberados." } as Record<string, string>)[role] || ""; }
